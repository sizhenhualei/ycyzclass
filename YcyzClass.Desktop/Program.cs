...
using YcyzClass.Platform.Windows;
using YcyzClass.Platform.Windows.Helpers;
using YcyzClass.Platform.Windows.Services;
#endif
#if Platforms_Linux
using YcyzClass.Platforms.Linux.Services;
#endif
#if Platforms_MacOs
using YcyzClass.Platforms.MacOs.Services;
#endif
...
class Program
{
    ...
    {
#if DEBUG
        if (!Debugger.IsAttached && Environment.GetEnvironmentVariable("YcyzClass_WaitDebuggers") == "1")
        {
        ...
        var buildApp = YcyzClass.Program.AppEntry(args);
