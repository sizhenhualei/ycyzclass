...
using YcyzClass.Models.AuthorizeProviderSettings;

namespace YcyzClass.Controls.AuthorizeProvider;

/// <summary>
/// PasswordAuthorizeProvider.xaml 的交互逻辑
/// </summary>
[AuthorizeProviderInfo("ycyzclass.authProviders.password", "密码", "\uec8b")]
