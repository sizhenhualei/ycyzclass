...
public partial class EditModeView : UserControl
{
    ...
    public EditModeView()
    {
        InitializeComponent();
        DataContext = this;
        ViewModel.TutorialService.Context["ycyzclass.mainWindow.editMode.mainDrawer.getState"] =
            () => ViewModel.MainDrawerState;
        ViewModel.TutorialService.Context["ycyzclass.mainWindow.editMode.secondaryDrawer.getState"] =
    ...
    protected override void OnAttachedToVisualTree(VisualTreeAttachmentEventArgs e)
    {
        ...
        _mainDrawerStateObserver ??= ViewModel.ObservableForProperty(x => x.MainDrawerState)
            .Subscribe(_ =>
            {
                ...
                {
                    ViewModel.TutorialService.PushToNextSentenceByTag("ycyzclass.mainwindow.editMode.componentsLib.closed");
                }
                UpdateComponentSettingsTabIndex();
            });
    }
    ...
    public void OpenComponentsLibDrawer(IList<ComponentSettings>? target = null)
    {
        ...
        ViewModel.TutorialService.PushToNextSentenceByTag("ycyzclass.mainwindow.editMode.componentsLib.open");
    }
    ...
    private void SettingsExpanderNavigateAppearance_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        ViewModel.UriNavigationService.NavigateWrapped(new Uri("ycyzclass://app/settings/appearance"));
    }
    ...
    public void ShowComponentSettings()
    {
        ...
        UpdateComponentSettingsTabIndex();
        ViewModel.TutorialService.PushToNextSentenceByTag("ycyzclass.mainwindow.editMode.componentSettings.open");
    }
    ...
    public void OpenChildComponents(ComponentSettings? settings, IReadOnlyList<ComponentSettings> stack, Point pos)
    {
        ...
        Dispatcher.UIThread.Post(() =>
        {
            ViewModel.TutorialService.PushToNextSentenceByTag(
                "ycyzclass.mainwindow.editMode.childrenComponent.open");
        });
    }
    ...
    private void ButtonOpenComponentLayoutsFolder_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        {
            FileName = Path.GetFullPath(YcyzClass.Services.ComponentsService.ComponentSettingsPath),
    ...
    private async void ButtonCreateComponentLayout_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        var path = Path.Combine(YcyzClass.Services.ComponentsService.ComponentSettingsPath,
            ViewModel.CreateProfileName + ".json");
        if (dialogResult != ContentDialogResult.Primary || File.Exists(path))
        {
            return;
        }
        ConfigureFileHelper.SaveConfig(path, YcyzClass.Services.ComponentsService.DefaultComponentProfile);
