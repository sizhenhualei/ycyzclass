...
using YcyzClass.Core.Converters;
using YcyzClass.Core.Enums;
using YcyzClass.Extensions;
using YcyzClass.Services;
using YcyzClass.Shared.Helpers;
using YcyzClass.Shared.IPC;
...
using YcyzClass.Shared.JsonConverters;
...
public static class Program
{
    ...
    public static Func<App> AppEntry(string[] args, Action? postInit = null)
    {
        ...
        var command = new RootCommand
        {
            ...
            new Option<string>(["--importV1"], "指定要导入的 YcyzClass 1.7 配置目录"),
            new Option<string>(["--importEntries"], "指定要导入的 YcyzClass 1.7 配置信息"),
            new Option<bool>(["--importComplete"], "启动时显示导入完成窗口"),
            new Option<bool>(["--importV1Complete"], "从 YcyzClass 1 导入成功"),
        ...
        // 修复特定情况下无法正常 DPI 缩放的问题 https://github.com/YcyzClass/YcyzClass/issues/1580
        ...
        var mutex = new Mutex(true, "Global\\YcyzClass.Lock", out var createNew);
