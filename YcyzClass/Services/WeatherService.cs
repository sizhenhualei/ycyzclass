...
public class WeatherService : ObservableRecipient, IHostedService, IWeatherService
{
    ...
    public WeatherService(SettingsService settingsService, ILogger<WeatherService> logger, IRulesetService rulesetService, ILocationService locationService)
    {
        ...
        RulesetService.RegisterRuleHandler("ycyzclass.weather.currentWeather", CurrentWeatherRuleHandler);
        RulesetService.RegisterRuleHandler("ycyzclass.weather.tomorrowWeather", TomorrowWeatherRuleHandler);
        RulesetService.RegisterRuleHandler("ycyzclass.weather.hasWeatherAlert", HasAlertRuleHandler);
        RulesetService.RegisterRuleHandler("ycyzclass.weather.rainTime", RainTimeRuleHandler);
        RulesetService.RegisterRuleHandler("ycyzclass.weather.sunRiseSet", SunRiseSetRuleHandler);
    ...
    {
        var w = AssetLoader.Open(new Uri("avares://YcyzClass/Assets/XiaomiWeather/xiaomi_weather_status.json",
            UriKind.Absolute));
