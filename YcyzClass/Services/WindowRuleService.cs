...
public class WindowRuleService : IWindowRuleService
{
    ...
    public WindowRuleService(ILogger<WindowRuleService> logger, IRulesetService rulesetService)
    {
        ...
        RulesetService.RegisterRuleHandler("ycyzclass.windows.className", ClassNameHandler);
        RulesetService.RegisterRuleHandler("ycyzclass.windows.text", TextHandler);
        RulesetService.RegisterRuleHandler("ycyzclass.windows.status", StatusHandler);
        RulesetService.RegisterRuleHandler("ycyzclass.windows.processName", ProcessNameHandler);
    }
    ...
    public unsafe bool IsForegroundWindowYcyzClass()
    {
        var pid = PlatformServices.WindowPlatformService.GetWindowPid(PlatformServices.WindowPlatformService
            .ForegroundWindowHandle);
