...
{
    public const string DefaultOnboardingToastTitle = "欢迎使用 YcyzClass (/≧▽≦)/";

    public const string DefaultOnboardingToastBody =
        "屏幕上的课表是由本大屏课表软件 YcyzClass 显示的。YcyzClass 能一目了然地显示各种信息，并支持高度自定义。要了解如何使用 YcyzClass 吗？";

    public const string DefaultRefreshingToastTitle = "翻新 YcyzClass";

    public const string DefaultRefreshingToastBody = "YcyzClass 似乎已经有一个长假没有启动了，部分设置可能已经过期。要跟随欢迎向导重新设置如学期开始时间等设置吗？";
