...
using YcyzClass.Views.WelcomePages;
using DynamicData;
...
public partial class WelcomeWindow : MyWindow, INavigationPageFactory
{
    ...
    {
        var startupPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Startup), "YcyzClass.lnk");
        var startMenuPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.StartMenu), "YcyzClass.lnk");
        var desktopPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory), "YcyzClass.lnk");
    ...
    private async Task CreateShortcutsFreedesktop()
    {
        ...
        var desktopPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory), "YcyzClass.desktop");
