...
using YcyzClass.Core.Models.ProfileAnalyzing;
...
public partial class DebugPage : SettingsPageBase
{
    ...
    private void MenuItemShowTestNotification_OnClick(object sender, RoutedEventArgs e)
    {
        var toastContent = new DesktopToastContent()
        {
            Title = "测试通知",
            Body = "Hello world!",
            HeroImageUri = new Uri("https://res.ycyzclass.tech/banners/banner-v2.webp"),
            LogoImageUri = new Uri("avares://YcyzClass/Assets/HoYoStickers/白厄_没事.png"),
            Buttons =
            {
