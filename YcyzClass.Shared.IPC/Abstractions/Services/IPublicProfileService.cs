...
namespace YcyzClass.Shared.IPC.Abstractions.Services;

/// <summary>
/// 向其它进程公开的档案服务，用于管理YcyzClass档案信息。
/// </summary>
...
public interface IPublicProfileService
{
    ...
    void ConvertToStdClassPlan(Guid id);
    ...
    void SetupTempClassPlanGroup(Guid key, DateTime? expireTime = null);
