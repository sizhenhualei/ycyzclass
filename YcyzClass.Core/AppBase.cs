...
public abstract class AppBase : Application, IAppHost
{
    ...
    public static string AppCodeName => "LiliyaOlenyeva";
    ...
    /// Fluent Icons 字体
    /// </summary>
    public static FontFamily FluentIconsFontFamily { get; } = new FontFamily("avares://YcyzClass.Core/Assets/Fonts/#FluentSystemIcons-Resizable");

    /// <summary>
    /// Lucide Icons 字体
    /// </summary>
    public static FontFamily LucideIconsFontFamily { get; } = new FontFamily("avares://YcyzClass.Core/Assets/Fonts/#lucide");
    
    /// <summary>
    /// SF Symbols 字体
    /// </summary>
    public static FontFamily SFSymbolsFontFamily { get; } = new FontFamily("avares://YcyzClass.Core/Assets/Fonts/#SF-Symbols");
