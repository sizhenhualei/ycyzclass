...
using YcyzClass.Core.Abstractions.Models.Components;
using YcyzClass.Core.Attributes;
using YcyzClass.Core.Services.Registry;
using CommunityToolkit.Mvvm.ComponentModel;

namespace YcyzClass.Core.Models.Components;
...
public class ComponentSettings : ObservableRecipient, IMainWindowCustomizableNodeSettings
{
    ...
    /// <summary>
    /// 要显示的组件Id，YcyzClass用这个来索引组件，与<see cref="ComponentInfo"/>的Guid一致。
    /// </summary>
    public string Id
    {
        get => _id;
