using YcyzClass.Core.Exceptions;
using System.IO;
using System.Security.Cryptography;
using System.Text.Json;
using System.Text.RegularExpressions;

namespace YcyzClass.Core.Helpers;
...
public static class ChecksumHelper
{
    ...
    /// 从发行日志中提取校验和。<br/>
    ///
    /// 可以被此方法提取的校验和信息字典（键为文件名，值为MD5校验和）包裹在以 YCYZCLASS_PKG_MD5 开头的注释标签中，并以 json 格式存储，例如：<br/>
    /// 
    /// &lt;!-- YCYZCLASS_PKG_MD5 {"YcyzClass.zip":"5D413B24956724B004B1069C0AA6B3DE"} --&gt;
    /// </summary>
    ...
    {
        var regex = new Regex(@"<!-- YCYZCLASS_PKG_MD5 (.+?) -->");
