...
HelloWRC.Dev（“我们”，“我们的”或“本公司”）重视您的隐私，并致力于保护您的个人数据。本隐私政策解释了我们如何收集、使用和保护您的信息。当您使用我们的应用程序 YcyzClass 时，您同意按照本隐私政策的规定收集和使用信息。

**1. 我们收集的信息**

当您使用 YcyzClass 时，我们会通过自托管的 Sentry 服务收集以下类型的信息：
