...
![Banner_昔涟](https://res.ycyzclass.tech/banners/cyrene_msp/banner.webp)

Cyrene_MSP（Cyrene Management Server Protocol） 是 YcyzClass 集控服务器与客户端用 GRPC 交流的协议规范。
...
| 概念 | 定义 |
| --- | --- |
| 客户端 | 指与集控服务器连接的 YcyzClass 应用本体，从集控服务器接收对应的资料和命令 |
| 服务端 | 指[集控服务器](https://github.com/YcyzClass/ManagementServer)的服务端软件，用于发放集控信息。 |
