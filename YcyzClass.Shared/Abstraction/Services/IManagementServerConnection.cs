...
namespace YcyzClass.Shared.Abstraction.Services;
...
public interface IManagementServerConnection 
{
    ...
    /// <summary>
    /// 从集控服务器获取Json信息。url中的模板将被替换，关于url模板，请见<a href="https://docs.ycyzclass.tech/management/client-identify#url-template">集控文档</a>。
    /// </summary>
    ...
    /// <summary>
    /// 从集控服务器获取Json信息，并写入到本地文件。url中的模板将被替换，关于url模板，请见<a href="https://docs.ycyzclass.tech/management/client-identify#url-template">集控文档</a>。
    /// </summary>
    /// <typeparam name="T">信息类型</typeparam>
    /// <param name="url">要获取的url</param>
