...
using ClassInfo = YcyzClass.Shared.Models.Profile.ClassInfo;
using Profile = YcyzClass.Shared.Models.Profile.Profile;
using Subject = YcyzClass.Shared.Models.Profile.Subject;

namespace YcyzClass.Shared.Extensions;
...
public static class CsesExtensions
{
    ...
    /// <summary>
    /// 将 CSES 格式的课表转换为 YcyzClass 格式的课表。
    /// </summary>
    /// <param name="profile">CSES 格式课表</param>
    /// <param name="mergeProfile">需要合并的 YcyzClass 课表</param>
    /// <returns>YcyzClass 格式课表</returns>
    public static Profile ToYcyzClassObject(this CsesSharp.Models.Profile profile, Profile? mergeProfile=null)
    {
    ...
    /// <summary>
    /// 将 YcyzClass 格式的课表转换为 CSES 格式的课表。
    /// </summary>
    /// <param name="profile">YcyzClass 格式课表</param>
